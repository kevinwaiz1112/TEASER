...
hauptordner_pfad = r'C:\03_Repos\SimData\Results'
...
# Alle Dateien im Hauptordner durchgehen
for ordner_name in os.listdir(hauptordner_pfad):
    ordner_pfad = os.path.join(hauptordner_pfad, ordner_name)
